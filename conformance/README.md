...
fields, custom constructors and the readiness of `self`, instance methods and which of them change `self`, computed properties, type-level functions and fields with their lazy setup, private members, field defaults, default parameters and named arguments, projects of several files with their namespaces, `using`, privacy and lazy module
