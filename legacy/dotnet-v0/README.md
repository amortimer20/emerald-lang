# Emerald — archived .NET v0 prototype

> **Historical archive:** this directory contains the original C#/.NET implementation and
> is no longer maintained. Its behavior is not authoritative for the Zig rewrite. The
> current language baseline is
...
deliverable. For this historical prototype, `docs/design.html` records the specification
and the argument for every decision in it.
